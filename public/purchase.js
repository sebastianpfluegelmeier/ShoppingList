...
var author$project$Main$GotPurchase = function (a) {
	return {$: 'GotPurchase', a: a};
};
var author$project$Main$GotShoppingListIds = function (a) {
	return {$: 'GotShoppingListIds', a: a};
};
var author$project$Main$Purchase = F5(
	function (id, name, price, personId, disabled) {
		return {disabled: disabled, id: id, name: name, personId: personId, price: price};
	});
...
var author$project$Main$purchaseDecoder = A6(
	elm$json$Json$Decode$map5,
	author$project$Main$Purchase,
	A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'price', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'personId', elm$json$Json$Decode$int),
...
var author$project$Main$init = function (id) {
	return _Utils_Tuple2(
		{id: id, purchase: elm$core$Maybe$Nothing, shoppingLists: elm$core$Maybe$Nothing},
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					elm$http$Http$get(
					{
						expect: A2(elm$http$Http$expectJson, author$project$Main$GotPurchase, author$project$Main$purchaseDecoder),
					...
					elm$http$Http$get(
					{
						expect: A2(
							...
							author$project$Main$GotShoppingListIds,
							elm$json$Json$Decode$list(elm$json$Json$Decode$int)),
						url: '/allUserShoppingListIds'
					})
				])));
};
...
var author$project$Main$purchaseEncoder = function (purchase) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(purchase.id)),
				_Utils_Tuple2(
				'name',
				elm$json$Json$Encode$string(purchase.name)),
				_Utils_Tuple2(
				'price',
				elm$json$Json$Encode$int(purchase.price)),
				_Utils_Tuple2(
				'personId',
				elm$json$Json$Encode$int(purchase.personId)),
				_Utils_Tuple2(
				'disabled',
				elm$json$Json$Encode$bool(purchase.disabled))
			]));
};
...
var author$project$Main$purchaseAndShoppingListsEncode = function (purchaseAndShoppingLists) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'purchase',
				author$project$Main$purchaseEncoder(purchaseAndShoppingLists.purchase)),
				_Utils_Tuple2(
				'shoppingLists',
				A2(elm$json$Json$Encode$list, author$project$Main$shoppingListEncoder, purchaseAndShoppingLists.shoppingLists))
			]));
};
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'GotPurchase':
					if (msg.a.$ === 'Ok') {
						var purchase = msg.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									purchase: elm$core$Maybe$Just(purchase)
								}),
				...
				case 'NameChanged':
					var name = msg.a;
					var _n1 = model.purchase;
					if (_n1.$ === 'Just') {
						var purchase = _n1.a;
						var purchaseUpdated = _Utils_update(
							purchase,
							{name: name});
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									purchase: elm$core$Maybe$Just(purchaseUpdated)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				...
				case 'PriceChanged':
					var price = msg.a;
					var _n2 = model.purchase;
					if (_n2.$ === 'Just') {
						var purchase = _n2.a;
						var purchaseUpdated = function () {
							var _n3 = elm$core$String$toInt(price);
							if (_n3.$ === 'Just') {
								var priceInt = _n3.a;
				...
				case 'GotShoppingList':
					if (msg.a.$ === 'Ok') {
						var shoppingList = msg.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									shoppingLists: elm$core$Maybe$Just(
										A2(
											elm$core$List$cons,
											shoppingList,
				...
				case 'AddItem':
							...
							item,
							{
								purchaseId: function () {
									var _n4 = _Utils_Tuple2(
										_Utils_eq(itemId, item.id),
										addItem);
									if (_n4.a) {
										if (_n4.b) {
											return elm$core$Maybe$Just(model.id);
										} else {
											return elm$core$Maybe$Nothing;
										}
									} else {
					...
					var updateShoppingList = function (shoppingList) {
						return _Utils_update(
							shoppingList,
							{
								list: A2(elm$core$Array$map, updateItem, shoppingList.list)
							});
					};
					var updateShoppingLists = function (shoppingLists) {
						return A2(elm$core$List$map, updateShoppingList, shoppingLists);
					};
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								shoppingLists: A2(elm$core$Maybe$map, updateShoppingLists, model.shoppingLists)
							}),
						elm$core$Platform$Cmd$none);
				case 'Save':
					return _Utils_Tuple2(
						...
						elm$http$Http$post(
							{
								body: elm$http$Http$jsonBody(
									author$project$Main$purchaseAndShoppingListsEncode(
										{
											purchase: A2(
												elm$core$Maybe$withDefault,
												{disabled: false, id: model.id, name: '', personId: 0, price: 0},
												model.purchase),
											shoppingLists: A2(elm$core$Maybe$withDefault, _List_Nil, model.shoppingLists)
										})),
								expect: elm$http$Http$expectWhatever(author$project$Main$Ignore),
								url: elm$core$String$concat(
									_List_fromArray(
										[
											'/purchaseAndShoppingListsJson/',
...
var author$project$Main$PriceChanged = function (a) {
	return {$: 'PriceChanged', a: a};
};
...
var author$project$Main$viewPurchase = function (purchase) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$getPurchaseItems = function (model) {
	return A2(
		elm$core$List$filter,
		function (item) {
			return _Utils_eq(
				A2(elm$core$Maybe$withDefault, -1, item.purchaseId),
				model.id);
		},
		elm$core$List$concat(
			A2(
				elm$core$List$map,
				function (list) {
					return elm$core$Array$toList(list.list);
				},
				A2(elm$core$Maybe$withDefault, _List_Nil, model.shoppingLists))));
};
...
var author$project$Main$viewPurchaseItems = function (model) {
	return A2(
		...
		A2(
			...
			A2(
				elm$core$List$map,
				author$project$Main$viewPurchaseItem,
				author$project$Main$getPurchaseItems(model))));
};
...
var author$project$Main$viewShoppingLists = F2(
	function (purchaseId, shoppingLists) {
		return A2(
			...
			A2(
				elm$core$List$map,
				author$project$Main$viewShoppingList(purchaseId),
				shoppingLists));
	});
