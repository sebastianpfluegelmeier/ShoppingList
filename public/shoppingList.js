...
var elm_community$array_extra$Array$Extra$removeAt = F2(
	function (index, xs) {
		var _n0 = A2(elm_community$array_extra$Array$Extra$splitAt, index, xs);
		var xs0 = _n0.a;
		var xs1 = _n0.b;
			...
			case 'ItemNameChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							list: A3(elm$core$Array$set, index, newItem, model.list)
						}),
					elm$core$Platform$Cmd$none);
			case 'NewItem':
				return _Utils_Tuple2(
			...
			case 'RemoveItem':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							list: A2(elm_community$array_extra$Array$Extra$removeAt, index, model.list)
						}),
					elm$core$Platform$Cmd$none);
			case 'Ignore':
...
var author$project$Main$ItemNameChanged = F2(
	function (a, b) {
		return {$: 'ItemNameChanged', a: a, b: b};
	});
var author$project$Main$NameChanged = function (a) {
	return {$: 'NameChanged', a: a};
};
var author$project$Main$NewItem = {$: 'NewItem'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('add new item')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
